...
public class ReasonScore implements CodeScoreRule<ReasonScore.ReasonRuleParam> {
    ...
    public Map<String, Object> getCodeRuleScore(ReasonRuleParam codeRuleParam) {
        ...
        if (codeRuleParam.getCardBaddebtCount() > 0) {
            reasonScore.append(",A1");
        }

        if (codeRuleParam.getLoanBaddebtCount() > 0) {
            reasonScore.append(",A2");
        }

        if (codeRuleParam.getBadLoanCount() > 0) {
            reasonScore.append(",A3");
        }

        if (codeRuleParam.getStandardCardBaddebtCount() > 0) {
            reasonScore.append(",A4");
        }

        if (codeRuleParam.getJudgementCount() > 0) {
            reasonScore.append(",A5");
        }

        if (codeRuleParam.getFellbackCount() > 0) {
            reasonScore.append(",A6");
        }

        if (codeRuleParam.getLoanOverdueNumLast24MonMax() > 7) {
            reasonScore.append(",B1");
        }

        if (codeRuleParam.getCardOverdueNumLast24MonMax() > 7) {
            reasonScore.append(",B2");
        }

        if (codeRuleParam.getStandardCardOverdueNumLast24MonMax() > 7) {
            reasonScore.append(",B3");
        }

        if (codeRuleParam.getCardOverdueNumLast12MonMax() > 2) {
            reasonScore.append(",C1");
        }

        if (codeRuleParam.getCardOverdueNumLast6MonMax() > 1) {
            reasonScore.append(",C2");
        }

        if (codeRuleParam.getCardOverdueLast12MonContSum() > 3) {
            reasonScore.append(",C3");
        }

        if (codeRuleParam.getCardOverdueLast6MonContSum() > 2) {
            reasonScore.append(",C4");
        }

        if(codeRuleParam.getSecdCustomerLoanOverdueLast6MonContSum() > 0){
            reasonScore.append(",C5");
        }

        if(codeRuleParam.getSecdCustomerLoanOverdueLast12MonContSum() > 1){
            reasonScore.append(",C6");
        }

        if(codeRuleParam.getSecdLoanOverdueNumLast12MonMax() > 1){
            reasonScore.append(",C7");
        }

        if (codeRuleParam.getCardOverdueAmtSum() > 0) {
            reasonScore.append(",D1");
        }

        if (codeRuleParam.getStandardCardOverdueAmt() > 500) {
            reasonScore.append(",D2");
        }

        if (codeRuleParam.getLoanOverdueAmtSum() > 0) {
            reasonScore.append(",D3");
        }
