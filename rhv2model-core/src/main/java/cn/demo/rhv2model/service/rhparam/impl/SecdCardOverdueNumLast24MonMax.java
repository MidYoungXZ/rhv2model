 ...
 * @description: 最近24个月贷记卡最高逾期期数
 * @author: liuyafei
 * @create: 2019/10/23 19:24
 */
public class SecdCardOverdueNumLast24MonMax implements Function<JSONObject, Object>, RhParamKey {

    static String resultKey="secd_CardOverdueNumLast24MonMax";
    ...
    /**
     * 1、当信贷交易信息明细（CreditDetail ）—》  基本信息段（Crt2_P_EssentialInformation） —》 账户类型（AccountType）=R2-贷记卡账户时，
