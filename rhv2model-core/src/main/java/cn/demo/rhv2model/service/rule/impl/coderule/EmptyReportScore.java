...
public class EmptyReportScore implements CodeScoreRule<EmptyReportScore.EmptyReportRuleParam> {

    private Map<String, Integer> emptyReportScoreMap;

    public EmptyReportScore() {
    ...
    public Map<String, Object> getCodeRuleScore(EmptyReportRuleParam codeRuleParam) {
        ...
        res.put("rhGradeModel4", emptyReportScoreMap.get(vStr + "_" + hStr));
        return res;
    }
}
