 ...
 * @description: 贷记卡近12月最高逾期期数
 * @author: liuyafei
 * @create: 2019/10/23 19:24
 */
public class SecdCardOverdueNumLast12MonMax implements Function<JSONObject, Object>, RhParamKey {

    static String resultKey="secd_CardOverdueNumLast12MonMax";
