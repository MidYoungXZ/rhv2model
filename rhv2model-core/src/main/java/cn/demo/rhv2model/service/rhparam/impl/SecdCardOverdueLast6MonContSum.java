 ...
 * @description: 贷记卡近6月逾期总次数
 * @author: liuyafei
 * @create: 2019/10/23 19:24
 */
public class SecdCardOverdueLast6MonContSum implements Function<JSONObject, Object>, RhParamKey {

    static String resultKey="secd_CardOverdueLast6MonContSum";
     ...
     * 2、信贷交易信息明细（CreditDetail ）—》最近24个月还款状态信息（Crt2_P_LastTwentyfourMonth） —》月份（month）取近6个月，还款状态（RepaymentState） G/D/B/Z及数字个数汇总
     * @param jsonObject
     * @return
     */
    @Override
