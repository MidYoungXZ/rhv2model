...
public class ZhongXinIncomeScore implements CodeScoreRule<ZhongXinIncomeScore.IncomeCodeRuleParam> {
    ...
    public Map<String, Object> getCodeRuleScore(IncomeCodeRuleParam codeRuleParam) {
        ...
        Integer result = Math.max(Math.max(scoreA, scoreB), scoreC);
        result=result/100*100;
        String rhGradeModel1=result+","+(result+100);
        res.put("rhGradeModel1", rhGradeModel1);
